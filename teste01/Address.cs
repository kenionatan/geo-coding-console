...
public class Address
{
    ...
    public void GeoCode()
    {
        ...
        string url = string.Format("https://maps.googleapis.com/maps/api/geocode/xml?address={0} +{1} +{2} +{3} +{4}&output=xml&oe=utf8&sensor=false&key={5}", Line1, City + ", ", State, Zip, Country, mapskey);
